...
import { getResults, resultPdfUrl, type ResultItem } from '../lib/api'
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-8 lg:py-12">
        ...
        {!loading && !error && results.length === 0 && (
          <div className="text-center py-24">
            <PdfIcon className="w-12 h-12 mx-auto mb-4" style={{ color: 'var(--color-outline)' }} />
...
function ResultCard({ item }: { item: ResultItem }) {
  ...
  const sizeStr = formatBytes(item.pdfOriginalSize)
      ...
      <div className="p-5 flex flex-col gap-3 flex-1">
        <div className="flex items-start gap-3">
          <div className="flex-shrink-0 w-10 h-10 rounded-[0.25rem] flex items-center justify-center"
            ...
            <PdfIcon className="w-5 h-5" style={{ color: 'var(--color-primary-cta)' }} />
          </div>
        ...
        <div className="mt-auto flex items-center justify-between pt-3 border-t"
          ...
          <a
            ...
            download={item.pdfFileName ?? 'resultado.pdf'}
